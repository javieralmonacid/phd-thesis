...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node at (-2.55, 0.1) {\tiny $m_1$};
        \node at (-2.85, 1.44) {\tiny $-$};
        \node at (-0.64, 0.1) {\tiny $m_2$};
        \node at (-1.15, 1.44) {\tiny $-$};
        \node at (2.15, 0.1) {\tiny $m_{\hspace{-0.15em}N}$};
        \node at (-3.5, 0.55) {\tiny CE$_1$};
        \node at (-3.5, -0.5) {\tiny PEE$_1$};
        \node at (-3.5, -1.26) {\footnotesize $l_1$};
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node at (-2.55, 0.1) {\tiny $m_1$};
        \node at (-0.63, 0.1) {\tiny $m_2$};
        \node at (2.1, 0.45) {\tiny $m_{\hspace{-0.15em}{N-1}}$};
        \node at (-3.5, 0.55) {\tiny CE$_1$};
        \node at (-3.5, -0.5) {\tiny PEE$_1$};
        \node at (-3.5, -1.26) {\footnotesize $l_1$};
...
\begin{figure}
    \centering
    \includegraphics[width=0.60\textwidth]{sketch_mtu_3D.pdf}
