...
\documentclass[twoside]{sfuthesis}
...
\committee{
    ...
    \member{Jay Gopalakrishnan}{External Examiner \\ Professor \\ Fariborz Maseeh Department of Mathematics and Statistics \\ Portland State University}
}
...
I gratefully acknowledge the financial support provided by Simon Fraser University through the Graduate Dean's Entrance Scholarship and the PhD Research Scholarship, as well as the support of the Department of Mathematics through the Travel and Research Awards that allowed me to communicate my research and create new connections.

\vfill

\begin{center}
    \includegraphics[scale=0.5]{nml-logo.png}
\end{center}
...
\chaptermark{Inertial effects in a mass-spring model of the MTU}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        \centering
        \node at (-2.9,1) {\huge \textbf{A}};
        \node[inner sep=0pt] at (0,0)
            {\includegraphics[width=0.3\textwidth]{hill-massless.eps}};
        \node at (-0.97,0.55) {\footnotesize CE};
        \node at (-0.97, -0.5) {\footnotesize PEE};
        \node at (1.35,-0.2) {SEE};
    ...
    \begin{tikzpicture}
        \centering
        \node at (-4.8,1) {\huge \textbf{B}};
        \node[inner sep=0pt] at (0,0)
            {\includegraphics[width=0.525\textwidth]{hill-mass-enhanced.eps}};
        \node at (-2.4, 0.1) {\tiny $m_1$};
        \node at (-2.85, 1.44) {\tiny $-$};
        \node at (-0.6, 0.1) {\tiny $m_2$};
        \node at (-1.15, 1.44) {\tiny $-$};
        \node at (2.0, 0.1) {\tiny $m_{\hspace{-0.15em}N}$};
        \node at (-3.3, 0.55) {\tiny CE$_1$};
        \node at (-3.3, -0.5) {\tiny PEE$_1$};
        \node at (-3.3, -1.26) {\footnotesize $l_1$};
        \node at (-1.55, 0.55) {\tiny CE$_2$};
        \node at (-1.55, -0.5) {\tiny PEE$_2$};
        \node at (-1.55, -1.26) {\footnotesize $l_2$};
        \node at (1.14, 0.55) {\tiny CE$_{\hspace{-0.15em}N}$};
        \node at (1.14, -0.5) {\tiny PEE$_{\hspace{-0.15em}N}$};
        \node at (1.14, -1.26) {\footnotesize $l_N$};
        \node at (3.15, -0.2) {\tiny SEE};
        \node at (3.15, -1.26) {\footnotesize $L_T$};
        ...
        \node at (2.45, 1.45) {\footnotesize $\vec{F}_T$};
...
\begin{figure}
    \centering
    \hspace*{-3em}\includegraphics[width=1.1\textwidth]{multibody-homog-study.png}
...
\chaptermark{Dynamical stability and the continuum limit}
...
\begin{definition}[Isometric contraction] \label{def:isometric_contraction}
    Consider a muscle modelled as a series of 1D elastic elements (i.e. as in the mass-enhanced model). We say that a muscle is contracted \textit{isometrically} if the total muscle length $L_M$ remains constant at all times, independent of the activation level. For the case of a muscle-tendon unit (MTU), we say the MTU is contracted isometrically if the combined length of muscle and tendon remains constant throughout the experiment, 
\end{definition}
...
\begin{figure}
    ...
    \begin{tikzpicture}
        ...
        \node at (-2.4, 0.1) {\tiny $m_1$};
        \node at (-0.6, 0.1) {\tiny $m_2$};
        \node at (2.0, 0.45) {\tiny $m_{\hspace{-0.15em}{N-1}}$};
        \node at (-3.3, 0.55) {\tiny CE$_1$};
        \node at (-3.3, -0.5) {\tiny PEE$_1$};
        \node at (-3.3, -1.26) {\footnotesize $l_1$};
        \node at (-1.52, 0.55) {\tiny CE$_2$};
        \node at (-1.45, -0.5) {\tiny PEE$_2$};
        \node at (-1.45, -1.26) {\footnotesize $l_2$};
        \node at (1.15, 0.15) {\tiny CE$_{{N-1}}$};
        \node at (1.15, -0.5) {\tiny PEE$_{{N-1}}$};
        \node at (3.1, 0.15) {\tiny CE$_{N}$};
        \node at (3.1, -0.5) {\tiny PEE$_{N}$};
        \node at (1.15, -1.26) {\footnotesize $l_{N-1}$};
        \node at (3.1, -1.26) {\footnotesize $l_{N}$};
        \node at (-2.8, 1.45) {\footnotesize $-\vec{F}_1$};
        \node at (-2.0, 1.45) {\footnotesize $\vec{F}_2$};
        \node at (-1.1, 1.45) {\footnotesize $-\vec{F}_2$};
        \node at (-0.3, 1.45) {\footnotesize $\vec{F}_3$};
        \node at (1.5, 1.45) {\footnotesize $-\vec{F}_{N-1}$};
        \node at (2.45, 1.45) {\footnotesize $\vec{F}_N$};
        \node at (0.1,0.14) {\footnotesize $\dots$};
        \node at (-0.1,-1.0) {\footnotesize $\dots$};
    \end{tikzpicture}
    }
...
\section[Nondimensionalization of the continuum system and the influence of mass]{Nondimensionalization of the continuum system and the influence of mass\sectionmark{Nondimensionalization and the influence of mass}}
\sectionmark{Nondimensionalization and the influence of mass}
...
\chaptermark{Time stepping for Neo-Hookean deformation}
...
\section[Neo-Hookean experiments, overshooting, and velocity approximations]{Neo-Hookean experiments, overshooting, and velocity approximations\sectionmark{NH experiments, overshooting, and velocity approximations}}
\sectionmark{NH experiments, overshooting, and velocity approximations}
...
\chaptermark{A Lagrangian framework for skeletal muscle}
...
\begin{figure}
    \centering
    \includegraphics[scale=0.65]{sketch_mtu_3D.pdf}
...
\begin{equation} \label{eq:def_Rine}
    R_{ine}(\*U^{n+1} ; \delta\*U) = \Delta t^{-2} \int_{\B_0} \rho_0 \*U^{n+1} \cdot \delta\*U - \Delta t^{-2} \int_{\B_0} \rho_0 \*U^n \cdot \delta\*U - \Delta t^{-1} \int_{\B_0} \rho_0 \*V^n \cdot \delta\*U,
\end{equation}
\begin{multline} \label{eq:def_Rint}
    R_{int}(\*U^{n+1}, p^{n+1}, D^{n+1} ; \delta\*U, \delta p, \delta D) = \int_{\B_0} \btau^{n+1} : \nabla_0(\delta\*U) \*F(\*U^{n+1})^{-1} \\
     + \int_{\B_0} \Big\{ J(\*U^{n+1}) - D^{n+1} \Big\} \cdot \delta p + \int_{\B_0} \Big\{ \psi'_{vol}(D^{n+1}) - p^{n+1} \Big\} \cdot \delta D,
\end{multline}
and
\begin{equation}
...
\begin{figure}
    \centering
    \includegraphics[width=0.95\textwidth]{geometry_muscle_block_with_pennation.pdf}
...
\section[The effect of mass and the force-velocity relationship in isometric contractions]{The effect of mass and the force-velocity relationship in isometric contractions\sectionmark{Mass and FV effects in isometric contractions}} \label{sec:flexodeal_dynamic_effects}
\sectionmark{Mass and FV effects in isometric contractions}
...
\section[Deformation of a human medial gastrocnemius during locomotion]{Deformation of a human medial gastrocnemius during locomotion\sectionmark{Deformation of a human MG during locomotion}} \label{sec:flexodeal_mri}
\sectionmark{Deformation of a human MG during locomotion}
...
\chaptermark{Gearing in muscle tissues}
...
\end{tabular}
\caption{Parameters describing the muscle stress-strain-rate relationship $\widehat{\sigma}_V$ used for 3D experiments.\label{tab:coef_3D_velocity}}
\end{table}
