...
In this thesis, we develop a rigorous scientific computing framework to study the nonlinear elastodynamics of 1D and 3D Hill-type muscle models, with an emphasis on models that are based on commonly-accepted physiological principles, and accepting the reality that more complex models will lead us to more involved numerical methods. The specific aims of this thesis are:
