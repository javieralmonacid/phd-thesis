...
\committee{
    ...
    \member{Nilima Nigam}{Supervisor \\ Professor, Mathematics}
    \member{James Wakeling}{Committee Member\\ Professor, Biomedical Physiology and Kinesiology}
    \member{Ben Adcock}{Internal Examiner \\ Professor, Mathematics}
    \member{Jay Gopalakrishnan}{External Examiner \\ Professor, Mathematics and Statistics \\ Portland State University}
}
...
\begin{figure}
    ...
    \hspace*{-0.9em}\includegraphics[width=1.03\textwidth]{multibody-homog-study.png}
...
\begin{figure}
    ...
    \scalebox{1.5}{\begin{tikzpicture}
        ...
        \node at (-2.31, 0.1) {\tiny $m_1$};
        \node at (-0.56, 0.1) {\tiny $m_2$};
        \node at (1.94, 0.4) {\tiny $m_{\hspace{-0.15em}{N-1}}$};
        \node at (-3.2, 0.5) {\tiny CE$_1$};
        \node at (-3.2, -0.5) {\tiny PEE$_1$};
        \node at (-3.2, -1.26) {\footnotesize $l_1$};
        \node at (-1.45, 0.5) {\tiny CE$_2$};
        ...
        \node at (-0.9, 1.45) {\footnotesize $-\vec{F}_2$};
        \node at (-0.3, 1.45) {\footnotesize $\vec{F}_3$};
        \node at (1.4, 1.45) {\footnotesize $-\vec{F}_{N-1}$};
