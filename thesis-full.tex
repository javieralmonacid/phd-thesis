...
In this Appendix, we describe the mathematical expressions used for the force relationships in this study. A GitHub repository that can be used as a submodule is available at:
\begin{center}
