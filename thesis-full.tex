...
Next, we compute muscle gearing as described in \eqref{eq:def_gearing} and display first this quantity as a function of force and MMV in Figure \ref{fig:g_elevated}, and as a function of force only for different maximum activation levels in Figure \ref{fig:g_gearing_v_force}. The results aligned with the well-established fact that muscle gearing decreases with increasing contractile force \cite{Eng2018} and that in general, muscle gearing is higher during faster contractions and lower during forceful contractions \cite{Azizi2008VariableGearing,Eng2018,Holt2016,RobertsEtAl2019MutiScale3DNature}.
...
As muscles contract to generate force, the muscle fibres (and consequently, the muscle as a whole) must deform transversally as well to keep its volume (nearly) constant \cite{BaskinPaolini}. In Figure \ref{fig:g_bulging} we show how the muscle width and thickness vary in the midsection of the muscle block in an asymmetric fashion, For instance, when the MMV is small, the width of the midsection increases and its thickness decreases with increasing activation. This asymmetrical deformation is consistent with the early findings of Azizi et al. \cite{Azizi2008VariableGearing}.
